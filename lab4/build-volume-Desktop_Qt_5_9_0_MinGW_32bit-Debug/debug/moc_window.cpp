...
QT_MOC_LITERAL(1, 14, 12), // "numberColour"
QT_MOC_LITERAL(2, 27, 0) // ""

    },
    "VolumeControl\0numberColour\0"
};
...
void VolumeControl::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        VolumeControl *_t = static_cast<VolumeControl *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->numberColour((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObject VolumeControl::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_VolumeControl.data,
      qt_meta_data_VolumeControl,  qt_static_metacall, nullptr, nullptr}
};
...
void *VolumeControl::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_VolumeControl.stringdata0))
        return static_cast<void*>(const_cast< VolumeControl*>(this));
